...
class JoinPidAndParametrs(models.Model):
    ...
    Param0_Name = models.CharField(max_length=128, default='', null=False, blank=False)
    ...
    Param1_Name = models.CharField(max_length=128, default='', null=False, blank=False)
    ...
    Param2_Name = models.CharField(max_length=128, default='', null=False, blank=False)
    ...
    Param3_Name = models.CharField(max_length=128, default='', null=False, blank=False)
    ...
    Param4_Name = models.CharField(max_length=128, default='', null=False, blank=False)
    ...
    Param5_Name = models.CharField(max_length=128, default='', null=False, blank=False)
