...
<div class="list-group mb-3">
  {% for member in site.data.core-team %}
    <a class="list-group-item list-group-item-action d-flex align-items-center" href="https://github.com/{{ member.user }}">
      <img src="https://github.com/{{ member.user }}.png" alt="kalaeishop - تجهیز صنعت - کلائی شاپ - پخش اواه و تجهیزات ایران -pakhsheloole va tajhizate iran" @{{ member.user }} width="32" height="32" class="rounded mr-2">
      <span>
